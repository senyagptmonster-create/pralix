...
class AppTheme {
  static const Color cBg = Color(0xFF0A0F1D);
  static const Color cSurface = Color(0xFF131C31);
  static const Color cEdge = Color(0xFF1F2D4E);
  static const Color cAccent = Color(0xFF0EA5E9);
